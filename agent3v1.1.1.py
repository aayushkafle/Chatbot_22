...
Original file is located at
    https://colab.research.google.com/drive/1c7Lg9kklxyOC2NBB0cvL9ppXv9IM2axZ
"""
...
def topic_choice_heuristic():
  ...
  # Similarily, if both jacsim lists are full of zeros, the one first in the list of topics is chosen.
